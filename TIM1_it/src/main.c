...
void init_tim1(void)
{
    ...
    TIM1->PSCRH = BYTE_1(0x07D0); // High bits of 2000d in prescaler
    TIM1->PSCRL = BYTE_0(0x07D0); // Low  bits of 2000d in prescaler

    TIM1->ARRH  = BYTE_1(0x03E8); // high bits of 1000d in auto-reload register
    TIM1->ARRL  = BYTE_0(0x03E8); // low  bits of 1000d in auto-reload register
